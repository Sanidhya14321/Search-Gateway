...
export default function EntityPage({ params }: { params: { id: string } }) {
  ...
  if (!data) return <main className="text-stone-300">Loading entity...</main>;

  return (
    <main className="space-y-6">
      <h1 className="font-display text-3xl text-stone-100">{data.canonical_name}</h1>
      <p className="text-stone-300">{data.summary}</p>
